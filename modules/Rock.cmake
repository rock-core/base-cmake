...
macro(rock_target_definition TARGET_NAME)
    ...
    if (QT_SOURCE_LENGTH GREATER 0)
        if(NOT TARGET Qt4::moc)
            message(FATAL_ERROR "you are requesting moc generation, but did not call rock_find_qt4(). Explicitely add rock_find_qt4() in your root CMakeLists.txt, just before calling rock_standard_layout()")
        endif()
